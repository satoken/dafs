/*
 * $Id: fa.cpp 97 2010-11-24 09:34:41Z sato-kengo $
 *
...
unsigned int
Fasta::
load(std::vector<Fasta>& data, const char* filename)
{
  std::list<Fasta> temp;
  unsigned int n=Fasta::load(temp, filename);
  data.resize(n);
