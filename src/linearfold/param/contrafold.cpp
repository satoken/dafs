...
#include "param_contrafold202.cpp"
...
CONTRAfoldNearestNeighbor(const std::string& seq) :
    ...
    score_base_pair_(contrafold202::score_base_pair),
    score_terminal_mismatch_(contrafold202::score_terminal_mismatch),
    score_hairpin_length_(contrafold202::score_hairpin_length),
    score_bulge_length_(contrafold202::score_bulge_length),
    score_internal_length_(contrafold202::score_internal_length),
    score_internal_explicit_(contrafold202::score_internal_explicit),
    score_internal_symmetry_(contrafold202::score_internal_symmetry),
    score_internal_asymmetry_(contrafold202::score_internal_asymmetry),
    score_bulge_0x1_(contrafold202::score_bulge_0x1),
    score_internal_1x1_(contrafold202::score_internal_1x1),
    score_helix_stacking_(contrafold202::score_helix_stacking),
    score_helix_closing_(contrafold202::score_helix_closing),
    score_multi_base_(contrafold202::score_multi_base),
    score_multi_unpaired_(contrafold202::score_multi_unpaired),
    score_multi_paired_(contrafold202::score_multi_paired),
    score_dangle_left_(contrafold202::score_dangle_left),
    score_dangle_right_(contrafold202::score_dangle_right),
    score_external_unpaired_(contrafold202::score_external_unpaired),
    score_external_paired_(contrafold202::score_external_paired),
    // 
    ...
    //
    cache_score_base_pair_(score_base_pair_.size(), std::vector<float>(score_base_pair_[0].size(), 0)),
    cache_score_helix_stacking_(score_helix_stacking_.size(), std::vector<std::vector<std::vector<float>>>(score_helix_stacking_[0].size(), std::vector<std::vector<float>>(score_helix_stacking_[0][0].size(), std::vector<float>(score_helix_stacking_[0][0][0].size(), 0)))),
    cache_score_internal_1x1_(score_internal_1x1_.size(), std::vector<float>(score_internal_1x1_[0].size(), 0)),
    //
    MAX_HAIRPIN_LENGTH(score_hairpin_length_.size()-1),
    MAX_BULGE_LENGTH(score_bulge_length_.size()-1),
    MAX_INTERNAL_LENGTH(score_internal_length_.size()-1),
    MAX_SINGLE_LENGTH(std::min(MAX_BULGE_LENGTH, MAX_INTERNAL_LENGTH)),
    MAX_INTERNAL_SYMMETRIC_LENGTH(score_internal_symmetry_.size()-1),
    MAX_INTERNAL_ASYMMETRY(score_internal_asymmetry_.size()-1),
    MAX_INTERNAL_EXPLICIT_LENGTH(score_internal_explicit_.size()-1)
{
