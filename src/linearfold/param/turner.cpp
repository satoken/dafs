...
TurnerNearestNeighbor(const std::string& seq) :
    ...
    use_score_hairpin_at_least_(false),
    use_score_bulge_at_least_(false),
    use_score_internal_at_least_(false),
    score_stack_(turner2004::score_stack),
    score_hairpin_(turner2004::score_hairpin),
    score_bulge_(turner2004::score_bulge),
    score_internal_(turner2004::score_internal),
    score_mismatch_external_(turner2004::score_mismatch_external),
    score_mismatch_hairpin_(turner2004::score_mismatch_hairpin),
    score_mismatch_internal_(turner2004::score_mismatch_internal),
    score_mismatch_internal_1n_(turner2004::score_mismatch_internal_1n),
    score_mismatch_internal_23_(turner2004::score_mismatch_internal_23),
    score_mismatch_multi_(turner2004::score_mismatch_multi),
    score_int11_(turner2004::score_int11),
    score_int21_(turner2004::score_int21),
    score_int22_(turner2004::score_int22),
    score_dangle5_(turner2004::score_dangle5),
    score_dangle3_(turner2004::score_dangle3),
    score_ml_base_(turner2004::score_ml_base),
    score_ml_closing_(turner2004::score_ml_closing),
    score_ml_intern_(turner2004::score_ml_intern),
    score_ninio_(turner2004::score_ninio),
    score_max_ninio_(turner2004::score_max_ninio),
    score_duplex_init_(turner2004::score_duplex_init),
    score_terminalAU_(turner2004::score_terminalAU),
    score_lxc_(turner2004::score_lxc),
    use_count_hairpin_at_least_(false),
    use_count_bulge_at_least_(false),
    use_count_internal_at_least_(false),
