...
struct gengetopt_args_info
{
  ...
  int use_bpscore_flag;	/**< @brief Use BP score (default=on).  */
  const char *use_bpscore_help; /**< @brief Use BP score help description.  */
  ...
  int use_alifold_flag;	/**< @brief Use RNAalifold for calculating base-pairing probabilities (default=off).  */
  const char *use_alifold_help; /**< @brief Use RNAalifold for calculating base-pairing probabilities help description.  */
  ...
  unsigned int use_bpscore_given ;	/**< @brief Whether use-bpscore was given.  */
  unsigned int extra_given ;	/**< @brief Whether extra was given.  */
